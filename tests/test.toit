...
main:
  ...
  expect_bytes_equal
    "foo".to_byte_array
    Hd44780.translate_to_rom_a_00 "foo"

  // Backslash is missing from the character ROM, so we
  // expect the error block to be called.
  expect_bytes_equal
    #[255]
    Hd44780.translate_to_rom_a_00 "\\": #[255]

  // The backslash is replaced by a Yen symbol in the pixel ROM.
  expect_bytes_equal
    "\\".to_byte_array
    Hd44780.translate_to_rom_a_00 "¥"

  HI := 0x80
  expect_bytes_equal
    #['j' + HI, 'u', 'm', 'p' + HI]
    Hd44780.translate_to_rom_a_00 "jump" --with_descenders
  ...
  expect_bytes_equal
    descenders
    Hd44780.translate_to_rom_a_00 alphabet --with_descenders

  expect_bytes_equal
    "jump".to_byte_array
    Hd44780.translate_to_rom_a_00 "jump" --with_descenders=false
  ...
  expect_bytes_equal
    #[0xb6, 0xc0, 0xb6, 0xc5]
    Hd44780.translate_to_rom_a_00 "カタカナ"

  // Todo is to-to-voiced-symbol.
  expect_bytes_equal
    #[0xc4, 0xc4, 0xde]
    Hd44780.translate_to_rom_a_00 "トド"
  ...
  expect_bytes_equal
    ...
    Hd44780.translate_to_rom_a_00 "ΣΩαβεθμπρσ"

  // Vowel-lengthening dash-like symbol (Ramen Restaurant).
  expect_bytes_equal
    #[0xd7, 0xb0, 0xd2, 0xdd]
    Hd44780.translate_to_rom_a_00 "ラーメン"
  ...
  expect_bytes_equal
    ...
    Hd44780.translate_to_rom_a_00 "Rückvergrößerungsgerät"

  // Abuse the handakuten sign as a degree symbol.
  expect_bytes_equal
    #['2', '5', 0xdf, 'C']
    Hd44780.translate_to_rom_a_00 "25°C"

  // Use lower case umlauts to replace upper case umlauts.
  expect_bytes_equal
    Hd44780.translate_to_rom_a_00 "über"
    Hd44780.translate_to_rom_a_00 "Über":
      if it == 'Ü':
        "ü"
      else if it == 'Ä':
  ...
  expect_bytes_equal
    Hd44780.translate_to_rom_a_00 "ee"
    Hd44780.translate_to_rom_a_00 "èé":
      if it == 'è':
        "e"
      else if it == 'é':
        "e"
